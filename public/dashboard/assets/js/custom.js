...
*************************/
    ...
    POTENZA.pniceScroll = function () {
        ...
        loadScript('dashboard/assets/'+plugin_path+ 'nicescroll/jquery.nicescroll.js', function() {
...
POTENZA.datatables = function () {
   // if ($('#datatable').exists()) {
   //     loadScript('dashboard/assets/'+plugin_path + 'bootstrap-datatables/jquery.dataTables.min.js', function() {
   //     loadScript('dashboard/assets/'+plugin_path + 'bootstrap-datatables/dataTables.bootstrap4.min.js', function() {
   //   // $('#datatable').DataTable();
   //   });
   //     });
   //  }
